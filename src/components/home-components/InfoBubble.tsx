export default function InfoBubble() {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-xl max-w-[50%] md:w-1/2">
      <h2 className="text-2xl font-bold mb-4 text-black">Your Health, Our Priority: How We Can Help?</h2>
      <div className="flex flex-col md:flex-row">
        <div className="md:w-1/2 md:pr-4">
          <p className="text-black mb-6 font-extralight">
        ...
        <div className="md:w-1/2 md:pl-4">
          <div className="grid grid-cols-2 gap-x-4 text-gray-700 mb-6">
